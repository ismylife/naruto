...
public class HttpUtils {
     ...
     * 
     * @方法名称:send
     * @描述: 执行某种网络请求的方法,如get,post...请求
     * @创建人：SYC
     * @创建时间：2014-11-21 下午4:20:51 
     * @备注：     
     * @param method:请求方式
     * @param url:请求的网址
     * @param callBack:请求完毕后的回调结果
     * @return   
     * @返回类型：HttpHandler<T>
     */
     ...
     * @描述: 执行某种网络请求的方法,如get,post...请求
     * @创建人：SYC
     * @创建时间：2014-11-21 下午4:22:07 
     * @备注：     
     * @param method:请求方式
     * @param url:请求的网址
     * @param params:请求参数
     * @param callBack:请求结束后的回调结果
     * @return   
     * @返回类型：HttpHandler<T>
     */
     ...
     * @描述: 执行请求
     * @创建人：SYC
     * @创建时间：2014-11-21 下午4:57:53 
     * @备注：     
     * @param request:某种请求方式
     * @param params:请求参数
     * @param callBack:结果回调
     * @return   
     * @返回类型：HttpHandler<T>
